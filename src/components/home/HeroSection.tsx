...
export const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-cover bg-center opacity-10" style={{
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          duration: 0.6
            ...
            duration: 0.4
              ...
              <span className="text-sm font-medium">Trusted by 90,000+ Applicants</span>
            </motion.div>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6">
              {trustBadges.map((badge, index) => <motion.div key={badge.text} initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
          ...
          duration: 0.6
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src={heroImage} alt="Professionals arriving for new opportunities" className="w-full h-auto object-cover" />
